...
class UserModule extends CWebModule {
  ...
  public static $dateFormat = "d-m-Y";  //"d.m.Y H:i:s"
  public $dateTimeFormat = 'd-m-Y G:i:s';  //"d.m.Y H:i:s"

  private $_urls=array(
    'login'=>array('//user/user'),
    //'return'=>array('//user/user/index'),
	//'return'=>array('//site/index'),
	'return'=>array('//shop/products/create'),
    'firstVisit'=>array('//user/privacy/update'),
	'firstVisit'=>array('//profile/profile/update'),
  ...
  public function init() {
	...
	//AppProfile::model()->getPayPalAPIUsername();
	
	$this->phpmailer=array(
                                //'transport'=>'smtp',
								'transport'=>AppProfile::model()->getEmailTransport(), 
                                'html'=>true,
                                'properties'=>array(
                                        'CharSet' => 'UTF-8',
				...
				//	'SMTPSecure' => 'tls',         // sets the prefix to the servier
                                        'Host' => AppProfile::model()->getEmailHost(),    // sets GMAIL as the SMTP server
                                        'Port' =>  AppProfile::model()->getEmailPort(),                   // set the SMTP port for the GMAIL server
                                        'Username' =>  AppProfile::model()->getEmailUsername(),  // GMAIL username
                                        'Password' =>  AppProfile::model()->getEmailPassword(),        // GMAIL password
                                ),
                                'msgOptions'=>array(
                                        //'fromName'=>'Registration System',
										'fromName'=>AppProfile::model()->getEmailUsername(),
                                        'toName'=>'Dearest sosopet user',
                                ),
                        );
	/*
	$this->phpmailer=array(
                                ...
                                'properties'=>array(
                                        ...
                                        'SMTPAuth' => true,            // enable SMTP authentication
                                        //'SMTPSecure' => 'ssl',         // sets the prefix to the servier
                                        'Host' => 'smtpout.secureserver.net',    // sets GMAIL as the SMTP server
                                        'Port' =>  '80',                   // set the SMTP port for the GMAIL server
                                        'Username' =>  'info@kickzmall.com',  // GMAIL username
