...
class Paypal extends PaymentGateway
{
	...
	public function validateIpn()
	{
		...
		// DEBUG
		//$fp_debug = fopen('../logs/ipn.debug.log','a');
		//fwrite($fp_debug, $urlParsed['path'] . "\n\n");
		//fwrite($fp_debug, $urlParsed['host'] . "\n\n");
		//fwrite($fp_debug, $postString . "\n\n");
		//fclose($fp_debug);
		// DEBUG
		...
		if (strpos($this->ipnResponse, "VERIFIED") !== false)
		{
			// DEBUG
			//$fp_debug = fopen('../logs/ipn.debug.log','a');
			//fwrite($fp_debug, $this->ipnResponse . "\n\n");
			//fclose($fp_debug);
			// DEBUG
