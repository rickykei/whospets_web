...
class PayPalAP
{
	...
	*/
	...
	$rr='';
		...
		$fp1 = fopen('images/ipnap2.log','a');
				fwrite($fp1, print_r($data_array,true)."\n\n");
				fclose($fp1);
	...
	public static function handleIpnx($data_array) {
		$ipn_post_data = $_POST;
