...
class AppImage extends CActiveRecord
{
	...
	{
		return Yii::app()->controller->module->appImageTable;
	}
	...
	{
		return array(
			'Sell' => array(self::BELONGS_TO, 'Sells', 'product_id'),
			'Qna' => array(self::BELONGS_TO, 'Qnas', 'product_id'),
			'Post' => array(self::BELONGS_TO, 'Posts', 'product_id'),
		);
	}
	...
	{
		$count = intval(AppImage::model()->countByAttributes(array(
