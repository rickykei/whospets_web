...
<div class="form">
	<fieldset id="billing_information" style="display: none;" >
        <div class="payment_address"> 
            <div class="content">
				<h2><?php echo Shop::t('new billing address'); ?></h2>
				<ul class="form-list">
				<li>
					<?php echo $form->labelEx($billingAddress,'title'); ?>
					<?php echo $form->dropDownList($billingAddress,'title',Shop::module()->titleOptions); ?>
				</li>
				...
				<li>
					<?php echo Shop::getCountryChooser($form, $billingAddress,array('prompt'=>'--select--')); ?>	
				</li>
			</div>
		</div>
   </fieldset>
