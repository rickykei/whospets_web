<div class="secondary_page_wrapper">
	<div class="container">
		...
		<?php
			...
			$cat_title = isset($category)?$category->title:'Search';
			$this->widget('application.components.widgets.BreadcrumbsWidget',array(
								'items'=>array(
												...
												array('description'=>Yii::t('shop','Search')),
											)
							)
						);
		?>
		<div class="row">
			...
			<main class="col-md-9 col-sm-8">
				<section class="section_offset">
					<h1><?php echo Yii::t('shop','Search');?></h1>
				</section>
				<!-- - - - - - - - - - - - - - Products - - - - - - - - - - - - - - - - -->
					...
					<header class="top_box on_the_sides">
						<div class="left_side clearfix v_centered">
							...
							<div class="v_centered">
								<span><?php echo Yii::t('shop','Sort by:');?></span>
								<div class="">
									<?php
										echo $form->dropDownList($model, 'sorting', array(''=>Yii::t('shop','Default'), 'price'=>Yii::t('shop','Price'), 'newest'=>Yii::t('shop','Date')));
									?>
								</div>
							</div>
							<!-- - - - - - - - - - - - - - End of sort by - - - - - - - - - - - - - - - - -->
