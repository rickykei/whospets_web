...
class FavoriteController extends Controller
{
	...
	{
		$model=$this->loadModelbyStoreId($store_id);
	...
	public function loadModel($id)
	{
		...
		$model=Favorite::model()->find('id=:id AND user_id=:user_id',
			array(
			  ':id'=>$id,
	...
	public function loadModelbyStoreId($id)
	{
		//$model=Wishlist::model()->findByPk($id);
		$model=Favorite::model()->find('store_id=:store_id AND user_id=:user_id',
			array(
			  ':store_id'=>$id,
			  ':user_id'=>Yii::app()->user->id,
			));
	...
	{
		return $this->renderPartial('_grid', array('store'=>$data->store), true);
	}
}
