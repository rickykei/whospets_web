...
class FeedbackController extends ShController
{
	/**
	...
	{
		$model = Feedback::model()->find('order_id = :order_id ', array(
						':order_id' => $order_id));
		...
		if(isset($_POST['Feedback']))
		{
			...
			if($model->save())
				$this->redirect(array('/shop/store/feedback','id'=>$model->store_id));
		}
