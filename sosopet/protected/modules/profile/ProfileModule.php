...
class ProfileModule extends CWebModule {
  public $adminLayout = 'application.views.layouts.main';
  public $layout = 'application.views.layouts.main';

  //public $requiredProfileFields = array('firstname', 'lastname', 'email');
  public $requiredProfileFields = array('email');
  //public $requiredProfileFields = array('email','tc');
  ...
  public $profileViewRoute = '//profile/profile/update';
